        ...
        <div className="container max-w-5xl mx-auto relative z-10">
          <div className="text-center space-y-6 animate-fade-in">
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight">
              Внедрение и обслуживание Системы <span className="text-primary">"Товарный Снайпер"</span>
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Вы получаете не просто "ведение рекламы", а полноценную систему, которая работает на вас 24/7. Я не просто привожу трафик, я строю управляемый и предсказуемый канал продаж для вашего интернет-магазина.
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="space-y-4">
                <div className="bg-primary/5 p-6 rounded-lg border-2 border-primary/20">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Провожу аудит и доработку вашего товарного фида. Нахожу и исправляю ошибки, из-за которых вы теряете до 80% релевантности. Обогащаю фид данными (размер, цвет, материал), чтобы Директ мог с ювелирной точностью показывать нужный товар на нужный запрос.
                  </p>
                </div>
                <div className="pt-4 border-t">
                  ...
                  <p className="text-muted-foreground leading-relaxed mb-3">
                    Провожу глубокий анализ вашей товарной матрицы по методу ABC, разделяя все товары на три категории:
                  </p>
                  <ul className="space-y-2 text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Icon name="Check" size={20} className="text-primary mt-0.5 flex-shrink-0" />
                      <span><strong>Группа А</strong> (20% товаров, дающие 80% выручки): Ваши "чемпионы". На них я направляю максимум внимания и бюджета.</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Icon name="Check" size={20} className="text-primary mt-0.5 flex-shrink-0" />
                    ...
                    <li className="flex items-start gap-2">
                      <Icon name="Check" size={20} className="text-primary mt-0.5 flex-shrink-0" />
                      <span><strong>Группа С</strong> (50% товаров, дающие 5% выручки): "Кандидаты на вылет". Я либо отключаю на них рекламу, чтобы не сжигать бюджет, либо ищу способы сделать их рентабельными.</span>
                    </li>
                  </ul>
        ...
        <div className="container max-w-4xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-lg opacity-90 leading-relaxed">
              Моя главная гарантия защиты вашего бюджета
            </p>
          </div>
          ...
          <Card className="p-4 md:p-8 bg-background text-foreground">
            ...
            <div className="bg-primary/10 p-6 rounded-lg mb-6">
              ...
              <p className="text-lg leading-relaxed text-foreground">
                Я гарантирую, что минимум 95% вашего рекламного бюджета будет инвестировано в переходы по релевантным связкам: поисковый запрос – заголовок объявления – карточка товара. Никаких кликов на синие подушки при запросе на зеленые.
              </p>
            </div>

            <div className="border-l-4 border-primary pl-6 mb-6">
              <p className="text-muted-foreground leading-relaxed">
                Если по итогам отчетного месяца внутренний аудит кампании показывает, что доля нецелевых расходов по моей вине превысила 5%, я компенсирую вам эту разницу, уменьшая стоимость "Сервисного Обслуживания" в следующем месяце на сумму перерасхода.
              </p>
            </div>

            <div className="bg-secondary/10 p-5 rounded-lg">
              <p className="text-base font-semibold text-foreground leading-relaxed">
                Это встроенный механизм защиты ваших инвестиций, который отличает мою систему от всего, что есть на рынке.
              </p>
            </div>
          </Card>
        </div>
